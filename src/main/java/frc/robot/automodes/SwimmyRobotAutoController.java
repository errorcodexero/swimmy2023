    ...
    private SwimmyTestAutoMode test_mode_ ;
        ...
        public SwimmyRobotAutoController(XeroRobot robot) throws MissingParameterException, BadParameterTypeException {
            ...
            try {
                ...
                addAutoMode(new SwimmyAutoPlaceCollectPlace(this, "Red Two Center", "Middle1", "Red", Location.Top, GamePiece.Cone, GridTagPosition.Right, Slot.Left, Location.Top, GamePiece.Cone, false));
                addAutoMode(new SwimmyAutoPlaceCollectPlace(this, "Blue Two Center", "Middle1", "Blue", Location.Top, GamePiece.Cone, GridTagPosition.Left, Slot.Right, Location.Top, GamePiece.Cone, false));

                addAutoMode(new SwimmyAutoPlaceCollectPlace(this, "Red Two Edge", "Edge1", "Red", Location.Top, GamePiece.Cone, GridTagPosition.Left, Slot.Right, Location.Top, GamePiece.Cone, false));
                addAutoMode(new SwimmyAutoPlaceCollectPlace(this, "Blue Two Edge", "Edge1", "Blue", Location.Top, GamePiece.Cone, GridTagPosition.Right, Slot.Left, Location.Top, GamePiece.Cone, false));
            }
            catch(Exception ex) {
