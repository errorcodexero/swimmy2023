...
public class GrabberStartCollectAction extends Action {
    ...
    public GrabberStartCollectAction(GrabberSubsystem sub) throws BadParameterTypeException, MissingParameterException {
        super(sub.getRobot().getMessageLogger());
        sub_ = sub ;

        hold_action_ = new MotorEncoderHoldAction(sub_.getGrabSubsystem(), "positions:open");
